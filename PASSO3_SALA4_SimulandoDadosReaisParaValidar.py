...
shape = 0.0881     # Parâmetro de forma (s)
loc = -351.2028   # Parâmetro de localização
scale = 463.7633    # Parâmetro de escala

# Configuração da simulação
num_dias = 1000             # Número de dias simulados
lambda_poisson = 2.35       # Média de pacientes por dia
turno_horas = 12
